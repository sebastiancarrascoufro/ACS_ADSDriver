...
void ADSDevioTesting::testInstanceMultiple(){
    std::cout << __FUNCTION__ << "():" << std::endl;
    adsDevio *interface_mp1 = new adsDevio("AMBSI_DEVICE", remoteIp, arr, port); 
    adsDevio *interface_mp2 = new adsDevio("AMBSI_DEVICE", remoteIp, arr, port); 
...
void ADSDevioTesting::testInstanceremoteIpError() {
    ...
    adsDevio *interface_mp1  = new adsDevio(dev, testRemoteIp, arr, port); 
    std::this_thread::sleep_for(std::chrono::milliseconds(100));
delete interface_mp1;
...
void ADSDevioTesting::testInstanceDeviceNameError() {
    ...
    adsDevio *interface_mp1  = new adsDevio(testDev, remoteIp, arr, port); 
    std::this_thread::sleep_for(std::chrono::milliseconds(100));
delete interface_mp1;
...
void ADSDevioTesting::testInstancePlcPortError() {
    ...
    adsDevio *interface_mp1  = new adsDevio(dev, remoteIp, arr, testPort); 
    std::this_thread::sleep_for(std::chrono::milliseconds(100));
delete interface_mp1;
}
void ADSDevioTesting::testInstanceAMSNetIdError() {
    ...
    adsDevio *interface_mp1  = new adsDevio(dev, remoteIp, testArr, port); 
    std::this_thread::sleep_for(std::chrono::milliseconds(100));
delete interface_mp1;
