...
GEN_LIST += ../config/$(MODULE_NAME)_SLAVE_SIM.c
...
GEN_TEMPLATES += amb/ADS/CDBComponentADS.xpt
GEN_TEMPLATES += amb/ADS/CDBInstanceADS.xpt
GEN_TEMPLATES += amb/ADS/CDBSchemaADS.xpt
GEN_TEMPLATES += amb/XMCSim/DeviceSimSlaveDotC.xpt
GEN_TEMPLATES += amb/XMCSim/DeviceSimSlaveDotH.xpt
